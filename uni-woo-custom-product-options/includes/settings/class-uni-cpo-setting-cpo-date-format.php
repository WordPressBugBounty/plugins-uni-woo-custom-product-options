...
class Uni_Cpo_Setting_Cpo_Date_Format extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
	...
	public function __construct() {
		$this->setting_key  = 'cpo_date_format';
		$this->setting_data = array(
			'title'              => __( 'Date format', 'uni-cpo' ),
			'is_tooltip'         => true,
			'is_tooltip_warning' => true,
			'desc_tip'           => __( 'For example: Y-m-d or d/m/Y etc', 'uni-cpo' ),
            'value'              => '{{- data }}'
		);
